...
class Settings(BaseSettings):
    ...
    PROFILING_OPENAI_MAX_RETRIES: int = 1
    PROFILING_SEARCH_CONTEXT_SIZE: str = "medium"
    PROFILING_RESEARCH_MAX_OUTPUT_TOKENS: int = 10000
    PROFILING_SYNTHESIS_MAX_OUTPUT_TOKENS: int = 16000
    PROFILING_MAX_CANDIDATE_SOURCES: int = 24
    PROFILING_MAX_DISPLAYED_SOURCES: int = 12
